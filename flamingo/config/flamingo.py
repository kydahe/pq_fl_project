...
print (f"Protocol Iterations: {num_iterations}, Clients: {num_clients}, Neighbor: {neighborhood_size*ceil(log2(num_clients))}, Agent: {agent_count}")
...
print (f"=> Collection phase: {results['srv_report'] + results['srv_crosscheck'] + results['srv_reconstruction']}")
print ()
