...
class SA_ServiceAgent(Agent):
    ...
    def initialize(self, currentTime):
        ...
        self.agent_print("run time for initialize step:", server_comp_delay)
        e_time = time.time()
        self.setup_time = e_time - s_time
        # print(e_time - s_time)
        print("initialize end time: {}".format(e_time))
    ...
    def report(self, currentTime):
        ...
        e_time = time.time()
        self.report_time = e_time - s_time
        # print(e_time - s_time)
        
        print("report end time: {}".format(e_time))
    ...
    def forward_signatures(self, currentTime):
        ...
        e_time = time.time()
        self.crosscheck_time = e_time - s_time
        # print(e_time - s_time)
        print("crosscheck end time: {}".format(e_time))
    ...
    def reconstruction(self, currentTime):
        ...
        self.current_round = 1
        e_time = time.time()
        self.reconstruction_time = e_time - s_time
        # print(e_time - s_time)
        print("reconstruction end time: {}".format(e_time))
        
        print("Total Time of Setup phase: {}".format(self.setup_time))
        print("Total Time of Collection phase: {}".format(self.report_time + self.crosscheck_time + self.reconstruction_time))
    ...
    def reconstruction_process(self):
        ...
        if len(self.committee_shares_pairwise) < self.committee_threshold:
            raise RuntimeError("No enough shares for decryption received: should be {} but {}.".format(self.committee_threshold, len(self.committee_shares_pairwise)))
